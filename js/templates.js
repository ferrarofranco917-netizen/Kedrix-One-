  ...
  return `
    ...
    <section class="panel">
      ...
      <div class="form-grid three practice-list-filter-grid density-medium">
        ...
        <div class="${Density.append('field', 'medium')}"><label for="practiceListExporter">${U.escapeHtml(T.t('ui.shipper', 'Mittente / esportatore'))}</label><input id="practiceListExporter" type="search" data-practice-list-filter="exporter" value="${U.escapeHtml(filters.exporter || '')}" autocomplete="off" /></div>
        <div class="${Density.append('field', 'medium')}"><label for="practiceListConsignee">${U.escapeHtml(T.t('ui.consignee', 'Destinatario'))}</label><input id="practiceListConsignee" type="search" data-practice-list-filter="consignee" value="${U.escapeHtml(filters.consignee || '')}" autocomplete="off" /></div>
