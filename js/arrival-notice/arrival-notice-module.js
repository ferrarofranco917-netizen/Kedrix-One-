window.KedrixOneArrivalNoticeModule = (() => {
  ...
  function queueDispatchForDraft(state, record, i18n) {
    ...
    return DocumentOps.queueDispatch(state, {
      moduleKey: 'arrival-notice',
      moduleLabel: i18n?.t('practices/notifica-arrivo-merce', 'Notifica arrivo merce') || 'Notifica arrivo merce',
      documentLabel: i18n?.t('practices/notifica-arrivo-merce', 'Notifica arrivo merce') || 'Notifica arrivo merce',
      ...
      subject: `${i18n?.t('practices/notifica-arrivo-merce', 'Notifica arrivo merce') || 'Notifica arrivo merce'} ${String(record?.practiceReference || '').trim()}`.trim(),
      snapshot: {
  ...
  function printDraft(draft, i18n, state) {
    if (DocumentOps && typeof DocumentOps.printHtmlDocument === 'function') {
      return DocumentOps.printHtmlDocument({
        title: i18n?.t('practices/notifica-arrivo-merce', 'Notifica arrivo merce') || 'Notifica arrivo merce',
      ...
      <section class="panel arrival-notice-editor-panel">
        <div class="panel-head">
          ...
          <div class="action-row">
            ...
            <button class="btn secondary" type="button" data-arrival-notice-email>${U.escapeHtml(i18n?.t('ui.saveAndSend', 'Salva e invia'))}</button>
